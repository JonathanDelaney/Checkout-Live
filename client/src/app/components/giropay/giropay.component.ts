...
@Component({
  selector: 'app-giropay',
  templateUrl: './giropay.component.html',
  styleUrls: ['./giropay.component.css']
})
export class GiropayComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.apiService.sessions(sessionsDto, this.configurationService.getCheckoutApiVersion).subscribe(async res => {
      ...
      await checkout.create('giropay').mount('#giropay-container');
    })
  }
